 ...
 */
function login() {
    return location.href = "http://47.107.182.64:8084/page/login";
}
function regist() {
    return location.href = "http://47.107.182.64:8084/page/register";
}
...
function search(a) {
    var b = "http://47.107.182.64:8082/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
